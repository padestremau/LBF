...
namespace LBF\RedactorBundle\DependencyInjection;
 ...
 */
class LBFRedactorExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        foreach ($config as $envName => $envConfig) {
            ...
            $container->setParameter(sprintf('lbf_redactor.%s', $envName), $envConfig);
        }
