...
namespace LBF\RedactorBundle\Form\Type;
...
use LBF\RedactorBundle\Model\RedactorService;
...
class RedactorType extends AbstractType
{
    ...
    /**
     * @var \LBF\RedactorBundle\Model\RedactorService
     */
    protected $redactorService;

    /**
     * @param \LBF\RedactorBundle\Model\RedactorService $redactorService
     */
