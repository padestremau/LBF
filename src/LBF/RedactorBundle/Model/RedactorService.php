...
namespace LBF\RedactorBundle\Model;
...
class RedactorService extends ContainerAware
{
    ...
    {
        return $this->container->getParameter(sprintf('lbf_redactor.%s', $envName));
    }
    ...
    {
        $settings = array();
        $config = $this->container->getParameter(sprintf('lbf_redactor.%s', $envName));
